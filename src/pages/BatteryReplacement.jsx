    ...
    <div className="container" style={{ padding: '6rem 2rem', minHeight: '60vh' }}>
      <div style={{ display: 'flex', alignItems: 'center', gap: '2rem', marginBottom: '2rem' }}>
        <div style={{ backgroundColor: 'var(--bg-card)', padding: '2rem', borderRadius: '50%', border: '1px solid var(--border-light)' }}>
          <Battery size={48} className="text-accent" />
        </div>
        <div>
          <span className="section-tag light">// BATTERY REPLACEMENT</span>
          <h1>POWER UP.</h1>
        </div>
      </div>
      
      <p style={{ color: 'var(--text-secondary)', maxWidth: '600px', fontSize: '1.125rem', marginBottom: '2rem' }}>
        If your phone is draining quickly, randomly shutting down, or taking forever to charge, a new battery will breathe new life into your device. We use high-capacity, certified batteries.
      </p>
